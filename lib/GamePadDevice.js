...
function _dumpValues(v) { // @arg Uint8Array
    ...
    // |        |      - |        |        |        | PAD_KEY_S1  (0 or 1)
    // |        |       -|        |        |        | PAD_KEY_S2  (0 or 1)
    // |        |        |----    |        |        | PAD_KEY_LX  (0 .. 7 .. 15) NEUTRAL is 0
    // |        |        |    ----|        |        | PAD_KEY_LY  (0 .. 7 .. 15) NEUTRAL is 0
    // |        |        |        |----    |        | PAD_KEY_RX  (0 .. 7 .. 15) NEUTRAL is 0
    // |        |        |        |    ----|        | PAD_KEY_RY  (0 .. 7 .. 15) NEUTRAL is 0
...
function input_NexusPlayer(buttons, // @arg GamePadButtonObjects
    ...
    // --- ANALOG ---
    var LX  = (axes[0] + 1) * 7 | 0; // 0 .. 7 .. 15 // L STICK X
    var LY  = (axes[1] + 1) * 7 | 0; // 0 .. 7 .. 15 // L STICK Y
    var RX  = (axes[2] + 1) * 7 | 0; // 0 .. 7 .. 15 // R STICK X
    var RY  = (axes[5] + 1) * 7 | 0; // 0 .. 7 .. 15 // R STICK Y
...
function input_DualShock4(buttons, // @arg GamePadButtonObjects
    ...
    // --- ANALOG ---
    var RY  = (axes[3] + 1) * 7 | 0; // 0 .. 7 .. 15 | R STICK Y
